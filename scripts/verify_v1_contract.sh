...
require_text "$DEVELOPMENT_SEQUENCE" 'current planned slice:'
...
require_text "$DEVELOPMENT_SEQUENCE" 'current planned slice: reinstall the global wrapper'
...
require_text "$FINAL_ROADMAP" '19 of 20 items executed'
