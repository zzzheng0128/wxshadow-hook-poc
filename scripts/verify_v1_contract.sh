...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3e-L3 observer perturbation | B0-S2 captured; three L3-A rows remain'
...
require_text "$F46_D4_R3E_L3_PLAN" 'B0-S2 is captured as baseline unstable'
require_text "$F46_D4_R3E_L3_PLAN" 'D4-R3e-L3-B0-baseline-unstable'
...
require_text "$FINAL_ROADMAP" 'B0-S2 evidence'
require_text "$DEVELOPMENT_SEQUENCE" 'B0-S2 is now captured'
