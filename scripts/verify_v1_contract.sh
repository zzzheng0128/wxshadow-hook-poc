...
require_text "$F46_PANIC_DIAGNOSIS" 'no D4-R3b reader-phase device evidence has been collected yet'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3b Lab App-only raw-hold split | Anchor fix in progress; reader pending'
...
require_text "$F46_D4_R3B_PLAN" 'Full device reader verification has not yet reached the reader phases'
