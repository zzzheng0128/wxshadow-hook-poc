...
require_text "$F46_EXIT_PLAN" 'Status: D3 Lab source is implemented and builds; D4 owner-exit smoke is next.'
...
require_text "$DEVELOPMENT_SEQUENCE" 'The current implementation'
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4 script-only owner-exit smoke'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4 two-slot owner-exit smoke | Current'
...
require_text "$FINAL_ROADMAP" 'F4.6-D4 owner-exit smoke is the next checkpoint'
