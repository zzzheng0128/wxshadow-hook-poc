...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.4-D1 is the next source checkpoint'
require_text "$DEVELOPMENT_SEQUENCE" 'Do not patch source from an inspection finding'
...
require_text "$F44_FORK_PLAN" 'Status: D0 plan gate passed; F4.4-D1 source migration is the next checkpoint.'
