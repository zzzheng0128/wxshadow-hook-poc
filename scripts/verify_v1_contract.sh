...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3b Lab App-only raw-hold split | Plan lock in progress'
...
require_text "$F46_D4_R3B_PLAN" 'Status: plan-lock packet'
...
require_text "$FINAL_ROADMAP" 'checkpoint is D4-R3b-P'
