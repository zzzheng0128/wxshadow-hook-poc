...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3d status-transport split | L1 local harness implemented; device pending'
...
require_text "$DEVELOPMENT_SEQUENCE" 'preserves the active hold after classification'
