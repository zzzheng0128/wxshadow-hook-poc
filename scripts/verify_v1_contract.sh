...
require_text "$F46_PANIC_DIAGNOSIS" 'Do not patch D4 before D4-R3e converts'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3e raw-hold lifetime plan | Planning gate'
...
require_text "$F46_D4_R3E_PLAN" 'D4-R3e-L1 | Smallest diagnostic packet only if justified'
