...
require_text "$F46_EXIT_PLAN" 'Source unlock requirements'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3 exit-hook release source packet | Current planning'
require_text "$DEVELOPMENT_SEQUENCE" 'D4-R3 source-packet planning is the'
...
require_text "$FINAL_ROADMAP" 'D4-R3 source-packet planning'
