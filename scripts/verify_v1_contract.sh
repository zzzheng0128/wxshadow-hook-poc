...
require_text "$F46_EXIT_PLAN" 'D4-R1 reboot-source decoupling is the current gate'
...
require_text "$F46_EXIT_PLAN" 'or Lab source edit may start from the D4 first-smoke timing alone.'
...
require_text "$F46_EXIT_PLAN" 'D4-R2 source packet'
...
require_text "$F46_PANIC_DIAGNOSIS" 'Do not rerun or patch D4 before D4-R1 explains which force-stop boundary is'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R1 reboot-source decoupling'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R1 reboot-source decoupling | Current'
require_text "$DEVELOPMENT_SEQUENCE" 'D4-R1 is'
require_text "$DEVELOPMENT_SEQUENCE" 'the only current work item'
...
require_text "$FINAL_ROADMAP" 'reboot-source decoupling is the next checkpoint'
