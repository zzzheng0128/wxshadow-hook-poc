...
require_text "$F46_PANIC_DIAGNOSIS" 'Do not rerun or patch D4 before D4-R3c converts'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3c status-reader split | Local harness passed; device pending'
...
require_text "$DEVELOPMENT_SEQUENCE" 'Local syntax/static/build gates passed; clean-source device verification remains pending'
...
require_text "$F46_D4_R3C_PLAN" 'The next device run must be done from clean source'
