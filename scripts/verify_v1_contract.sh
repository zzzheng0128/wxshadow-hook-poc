...
require_text "$DEVELOPMENT_SEQUENCE" 'clean-source device row is stable'
require_text "$DEVELOPMENT_SEQUENCE" 'read-only audit of abort-wrapper routing'
...
require_text "$FINAL_ROADMAP" '19 of 19 items executed'
require_text "$FINAL_ROADMAP" 'D4-R3f-source-uxn-no-abort-stable'
require_text "$FINAL_ROADMAP" 'read-only wrapper routing/lifetime audit'
...
require_text "$DEVELOPMENT_SEQUENCE" 'slice is a read-only audit'
