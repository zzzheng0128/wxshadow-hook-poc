...
require_text "$F46_EXIT_PLAN" 'Status: D4 first-smoke evidence is captured and under D4-R0 classification.'
...
require_text "$F46_EXIT_PLAN" 'No KPM or Lab source edit may start from this evidence alone.'
...
require_text "$F46_PANIC_DIAGNOSIS" 'Status: D2 recovery complete, D3 Lab two-slot hold built, and D4 first-smoke'
...
require_text "$F46_PANIC_DIAGNOSIS" 'Do not rerun or patch D4 before D4-R0 explains the first-smoke boundary.'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R0 failure classification'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R0 failure classification | Current'
...
require_text "$FINAL_ROADMAP" 'D4-R0 failure classification is the next checkpoint'
