...
require_text "$F46_EXIT_PLAN" 'isolation is the current gate'
...
require_text "$F46_PANIC_DIAGNOSIS" 'Do not rerun or patch D4 before D4-R2 explains whether the blocker is'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R2 explicit-clear cleanup isolation | Current'
require_text "$DEVELOPMENT_SEQUENCE" 'D4-R2 is the only current work item'
