...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3e-L3 observer perturbation | B0-S2 and B1-S2 captured; two L3-A rows remain'
...
require_text "$F46_D4_R3E_L3_PLAN" 'B0-S2 and B1-S2 are captured as unstable'
require_text "$F46_D4_R3E_L3_PLAN" 'D4-R3e-L3-B0-baseline-unstable'
...
require_text "$F46_D4_R3E_L3_PLAN" 'The next row is B0-S3'
...
require_text "$FINAL_ROADMAP" 'B0-S2 and B1-S2 evidence'
require_text "$FINAL_ROADMAP" 'B0-S2 and B1-S2 are captured as unstable'
