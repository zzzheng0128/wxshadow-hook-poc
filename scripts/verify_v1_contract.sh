...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3c status-reader split | Plan-only active'
...
require_text "$F46_D4_R3C_PLAN" 'Status: plan-only checkpoint'
...
require_text "$F46_D4_R3C_PLAN" 'No source implementation is opened by this file.'
