...
require_text "$F46_D4_R3I_PLAN" 'Status: device row classified stable; active hold preserved pending physical'
...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3i abort-lock exposure | Complete/classified stable; hold preserved'
