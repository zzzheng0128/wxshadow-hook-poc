...
require_text "$DEVELOPMENT_SEQUENCE" 'F4.6-D4-R3 exit-hook release source packet | Current source packet'
require_text "$DEVELOPMENT_SEQUENCE" 'delayed `exit_mmap` wrapper detach plus fixed-slot'
require_text "$DEVELOPMENT_SEQUENCE" 'the delayed `exit_mmap` wrapper-lifetime and fixed-slot callback-scan delta'
...
require_text "$FINAL_ROADMAP" 'D4-R3 source packet'
require_text "$FINAL_ROADMAP" 'delayed `exit_mmap` wrapper'
require_text "$FINAL_ROADMAP" 'Passing D4-R3 queues D4-R4 full owner-exit'
