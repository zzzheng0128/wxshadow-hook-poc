...
require_contains "$RAW_OUTPUT" 'operations=1,2,3,4,5'
require_contains "$RAW_OUTPUT" 'dispatch=patch_word,release_patch,patch_range,release_range,read_cycle'
...
require_contains "$RAW_OUTPUT" 'patch_range_op=4'
require_contains "$RAW_OUTPUT" 'release_range_op=5'
...
require_contains "$RAW_OUTPUT" 'patch_record_slots=1'
require_contains "$RAW_OUTPUT" 'patch_active_count=0'
require_contains "$RAW_OUTPUT" 'patch_dirty_bytes=0'
